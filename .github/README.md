...
[`@aws-sdk/client-rbin`](https://www.npmjs.com/package/@aws-sdk/client-rbin/v/3.94.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rbin@3.94.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iHJBlpJMOc5t1FsALeysv3p5y1HB9XDfsXcLnQGErRFCP/Kpr7g1OPTnd9VEUDle
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-rbin": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rbin@3.94.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rbin@3.94.0/index.min.mjs": "sha384-iHJBlpJMOc5t1FsALeysv3p5y1HB9XDfsXcLnQGErRFCP/Kpr7g1OPTnd9VEUDle"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-rbin/blob/refs/tags/3.94.0/LICENSE
```
