...
[`@aws-sdk/client-rbin`](https://www.npmjs.com/package/@aws-sdk/client-rbin/v/3.1059.0).
...
- @aws-sdk/client-rbin - [https://cloud-sdk-builds.github.io/?sdk=client-rbin](https://cloud-sdk-builds.github.io/?sdk=client-rbin)
- @aws-sdk/client-rbin v3.1059.0 - [https://cloud-sdk-builds.github.io/?sdk=client-rbin&version=3.1059.0](https://cloud-sdk-builds.github.io/?sdk=client-rbin&version=3.1059.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rbin@3.1059.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SOEj5ACi0LoJHYAPEhQDslmLuFkKrEVc+Er7QsRYbszNDHglvme66tH78x7ZWEYC
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rbin/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-rbin": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rbin@3.1059.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rbin@3.1059.0/index.min.mjs": "sha384-SOEj5ACi0LoJHYAPEhQDslmLuFkKrEVc+Er7QsRYbszNDHglvme66tH78x7ZWEYC"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-rbin";
...
```
https://github.com/cloud-sdk-builds/client-rbin/blob/refs/tags/3.1059.0/LICENSE
```
