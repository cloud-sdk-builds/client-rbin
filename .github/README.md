...
[`@aws-sdk/client-rbin`](https://www.npmjs.com/package/@aws-sdk/client-rbin/v/3.857.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rbin@3.857.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7nta66/Gtr9WYb4SOY23eMUVEl7aRAjoafEdFGxjVq7Mi2UNHzCI0GP8yLbVtpHR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-rbin": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rbin@3.857.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rbin@3.857.0/index.min.mjs": "sha384-7nta66/Gtr9WYb4SOY23eMUVEl7aRAjoafEdFGxjVq7Mi2UNHzCI0GP8yLbVtpHR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-rbin/blob/refs/tags/3.857.0/LICENSE
```
